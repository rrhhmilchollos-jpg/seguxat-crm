...
function CatalogoView({ token, currentUser }) {
  ...
  const ADDONS_PRO = [
    ...
    { id: "addon-sensor", name: "Sensor de apertura adicional", precio: 29, cuota: 1.90 },
    { id: "addon-humo", name: "Detector de humo adicional", precio: 45, cuota: 2.90 },
    { id: "addon-mando", name: "Mando a distancia armado/desarmado", precio: 25, cuota: 0.90 },
    { id: "addon-llavero", name: "Llavero de proximidad", precio: 19, cuota: 0.90 },
    { id: "addon-sensor-movimiento", name: "Sensor de movimiento PIR adicional", precio: 35, cuota: 1.90 },
    { id: "addon-sirena-ext", name: "Sirena exterior con flash LED", precio: 65, cuota: 3.90 },
    { id: "addon-sensor-rotura", name: "Sensor de rotura de cristal", precio: 39, cuota: 1.90 },
    { id: "addon-detector-inundacion", name: "Detector de inundación", precio: 32, cuota: 1.90 },
    { id: "addon-detector-gas", name: "Detector de gas (butano/natural)", precio: 49, cuota: 2.90 },
    { id: "addon-teclado", name: "Teclado adicional con pantalla LCD", precio: 59, cuota: 2.90 },
    { id: "addon-repetidor", name: "Repetidor de señal inalámbrico", precio: 42, cuota: 1.90 },
    { id: "addon-cerradura", name: "Cerradura electrónica inteligente", precio: 189, cuota: 5.90 },
    { id: "addon-boton-panico", name: "Botón de pánico inalámbrico", precio: 22, cuota: 1.90 },
    { id: "addon-sensor-perimetral", name: "Sensor perimetral de barrera IR", precio: 89, cuota: 3.90 },
  ];
